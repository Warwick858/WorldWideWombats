...
{
    /// <summary>
    /// This class models a Salary Employee.
    /// It contains all Salary Employee methods & data.
    /// This class inherits from the Employee base class.
    /// This class also has a derived Sales class.
    /// </summary>
    [Serializable]
    public class Salary : Employee
    {
        ...
        public Salary(EType empType, string empID, string firstName, string middle, string lastName, string marital, string fPTime,
            string department, string title, DateTime startDate, double monthlySalary)
        ...
        {
            //If the object this is being compared to is Salary
            if (obj is Salary)
            {
                Salary that = obj as Salary;
                return (EmpID == that.EmpID) && (FirstName == that.FirstName) &&
                    (LastName == that.LastName) && (MonthlySalary == that.MonthlySalary);
            } // end if
